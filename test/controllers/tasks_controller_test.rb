...
class TasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'post create: creates a task' do
    assert_difference 'Task.count', 1 do
      post api_v1_board_list_tasks_path(locale: 'es', board_id: @list, list_id: @list), params: { task: { title: 'new task', description: 'new description' } }
      assert_response :success
  ...
  test 'put update: edits a task' do
    assert_difference 'Task.count', 0 do
      put api_v1_board_list_task_path(locale: 'es', board_id: @list, list_id: @list, id: @task), params: { task: { title: 'edited task' } }
      assert_response :success
  ...
  test 'patch update: edits a task' do
    assert_difference 'Task.count', 0 do
      patch api_v1_board_list_task_path(locale: 'es', board_id: @list, list_id: @list, id: @task), params: { task: { title: 'edited task' } }
      assert_response :success
